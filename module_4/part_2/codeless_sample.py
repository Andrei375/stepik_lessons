...
class TestTestlogin():
    ...
    def test_testlogin(self):
        ...
        self.driver.find_element(By.ID, "id_registration-email").send_keys("kosmos10@tut.by")
        self.driver.find_element(By.ID, "id_registration-password1").click()
        self.driver.find_element(By.ID, "id_registration-password1").send_keys("{j[jne[t7Ktn")
        self.driver.find_element(By.ID, "id_registration-password2").click()
        self.driver.find_element(By.ID, "id_registration-password2").send_keys("{j[jne[t7Ktn")
